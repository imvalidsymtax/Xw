...
type
  TXwLangBase = class abstract(TInterfacedObject, IXwLang)
    strict private
      FLetters: string;                 // kanoniczne, po jednej na klasÍ
  ...
  TXwLangPL = class(TXwLangBase)
    strict private const
      CNAME    = 'PL';
      CLETTERS = 'A•BC∆DE FGHIJKL£MN—O”PQRSåTUVWXYZèØ';
    strict private
      FDiacritics: Boolean;
    protected
...
begin
  ...
  begin
    AMessage := Format('Fraza "%s": d≥ugoúÊ poza zakresem %d..%d.',
